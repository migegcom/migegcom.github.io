...
//播放页面广告
$ad1 = '<a href="http://t.cn/R4lxXRR" target="_blank"><img width="910" src="http://wx3.sinaimg.cn/large/6b229b76gy1fisb8t9nhvg20qo02iwen.gif"></a>';
$ad2 = '<a href="http://t.cn/R4lxXRR" target="_blank"><img width="910" src="http://wx3.sinaimg.cn/large/6b229b76gy1fisb8t9nhvg20qo02iwen.gif"></a>';

//*******************************分割线*******************************//

//下面代码请勿修改，否则会出现错误！
$CS_url = "http://".$_SERVER["HTTP_HOST"].$_SERVER['PHP_SELF'];
$error = "<script>alert('页面不存在!');top.location.href='$CS_url'</script>";
if(isset($_GET['v'])){
//*******************************播放页面*******************************//
...
//*******************************列表页面*******************************//
	...
	switch ($l){
		...
		break;
		case "3":
		$peg = "DJ舞曲，一首首HIGH翻天，让你犹如亲临迪斯科现场！";
	...
	$title = $peg." - ".$bati;
	$main = "<div class=\"main\"><div style=\"float:left;\">".$peg."</div><div style=\"float:right;\"><a href=\"?p=1\" class=\"btn\">恋爱的歌</a>&nbsp;&nbsp;<a href=\"?p=2\" class=\"btn\">TOP排行榜</a>&nbsp;&nbsp;<a href=\"?p=3\" class=\"btn\">DJ舞曲</a></div></div>";
	$data = curl_get($url);
...
<div class="header">
	<div class="h_main">
		<div class="logo"><a href="<?php echo $CS_url;?>" title="首页"></a></div>
		<ul class="menus">
...
eval(function(p,a,c,k,e,r){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('4.I("U").f="5://V.W.v.3/t/6/13.6?19="+1c.1g(1n O()/P);1 T(){9(r.q.X==""){7.e(\'请输入歌曲名称!\');r.q.1a();p g}}$("#1h").1l("i",1(){7.x({y:2,z:g,A:["B","C"],D:g,E:["5://F.G.H.1q.J.3/K.L","M"]})});$(4).N(1(){9(h.j){$(".k").i(1(){h.j.R("S",$(l).m("n").o());7.e(\'外链复制成功!\')})}w{$(".k").Y({Z:"5://10.11.3/t/12/d/14/15.16",17:1(){p $(l).m("n").o()},18:1(){7.e(\'外链复制成功!\')}})}});(1(){c a=4.1b("d");c b=h.1d.1e.1f(":")[0];9(b==="u"){a.f="u://1i.1j.3/1k/8.6"}w{a.f="5://8.1m.v.3/8.6"}c s=4.1o("d")[0];s.1p.Q(a,s)})();',62,89,'|function||com|document|http|js|layer|push|if|||var|script|msg|src|false|window|click|clipboardData|copy_btn|this|prev|input|val|return|ac|post_new||static|https|baidu|else|open|type|title|area|790px|450px|shadeClose|content|7d9nuh|com1|z0|getElementById|clouddn|upimg|html|no|ready|Date|3600000|insertBefore|setData|Text|CheckPost|bdshell_js|bdimg|share|value|zclip|path|www|sinacloud|home|shell_v2|app|ZeroClipboard|swf|copy|afterCopy|cdnversion|focus|createElement|Math|location|protocol|split|ceil|img|zz|bdstatic|linksubmit|on|zhanzhang|new|getElementsByTagName|parentNode|glb'.split('|'),0,{}))
</script>
<!-- bottom Start -->
<div class="bottom"> 
<p>声明：本站不存储任何音频数据，站内歌曲来自搜索引擎，如有侵犯版权请及时联系我们，我们将在第一时间处理！</p>
<p><script language="javascript">var datatime=new Date(); document.write("&copy; 2010-"+datatime.getFullYear()+".");</script> <?php echo $bati;?> <?php echo $lxfs;?> <a target="_blank" href="http://member.down.admin5.com/uploads/userup/1718/1.zip">下载本站源码</a></p>
<p style='display:none'>
<!-- tongji Start -->
<script language="javascript" type="text/javascript" src="//js.users.51.la/18968191.js"></script>
<noscript><a href="//www.51.la/?18968191" target="_blank"><img alt="&#x6211;&#x8981;&#x5566;&#x514D;&#x8D39;&#x7EDF;&#x8BA1;" src="//img.users.51.la/18968191.asp" style="border:none" /></a></noscript>
<!-- tongji End -->
</p>
</div>
<!-- bottom End -->
